...
<head>
    ...
    <title>La Casa de los Gatos</title>
			...
			<div class="container-hero">
				<div class="container hero">
					...
					<div class="container-logo">
						...
						<h1 class="logo"><a href="/">La Casa de los Gatos</a></h1>
					</div>
...
body {
    ...
    background-color: #f5f5f0; /* Color de fondo suave */
    margin: 0;
    padding: 0;
}
...
.juana {
    ...
    margin: 50px auto;
    padding: 20px;
    background-color: #d2b48c; /* Color de fondo marrón claro */
    border-radius: 8px;
...
h1, h2 {
    text-align: center;
    margin-bottom: 20px;
    color: #4b3d29; /* Color marrón oscuro para los encabezados */
}
...
label {
    margin-bottom: 5px;
    font-weight: bold;
    color: #4b3d29; /* Color marrón oscuro para las etiquetas */
}
...
select {
    margin-bottom: 15px;
    padding: 10px;
    border: 1px solid #b29f83; /* Color de borde marrón claro */
    border-radius: 4px;
    font-size: 16px;
}
...
button {
    padding: 10px;
    background-color: #8b5a2b; /* Color marrón medio */
    border: none;
    color: #fff;
    font-size: 16px;
    border-radius: 4px;
...
button:hover {
    background-color: #7a4e2a; /* Color marrón más oscuro al pasar el ratón */
}
...
.reservacion {
    ...
    border-radius: 4px;
    margin-bottom: 15px;
    background-color: #f0e6d2; /* Color de fondo para las reservaciones */
}

.reservacion h3 {
    margin: 0;
    color: #4b3d29; /* Color marrón oscuro para los títulos de reservación */
}

.reservacion p {
    margin: 5px 0;
    color: #4b3d29; /* Color marrón oscuro para el texto */
}
</style>
</head>
<body>
				...
				<div class="menu-footer">
					<div class="contact-info">
						...
						<ul>
							...
							<li>Fax: 55555300</li>
							<li>EmaiL: lacasadelosgatos's@gmail.com</li>
						</ul>
