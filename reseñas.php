...
body {
    ...
    background-color: #d9c6c0; /* Color de fondo suave */
    margin: 0;
    padding: 0;
}
...
.leo {
    ...
    margin: 50px auto;
    padding: 20px;
    background-color: #d2a68a; /* Color marrón claro */
    border-radius: 8px;
...
h1, h2 {
    text-align: center;
    margin-bottom: 20px;
    color: #4a3d3d; /* Color marrón oscuro para los encabezados */
}
...
label {
    margin-bottom: 5px;
    font-weight: bold;
    color: #4a3d3d; /* Color marrón oscuro para las etiquetas */
}
...
select {
    margin-bottom: 15px;
    padding: 10px;
    border: 1px solid #b89a8e; /* Color de borde marrón claro */
    border-radius: 4px;
    font-size: 16px;
}
...
button {
    padding: 10px;
    background-color: #9e6e5d; /* Color marrón medio */
    border: none;
    color: #fff;
    font-size: 16px;
    border-radius: 4px;
...
button:hover {
    background-color: #8b5a4e; /* Color marrón más oscuro al pasar el ratón */
}
...
.dos {
    padding: 15px;
    border: 1px solid #c2a39a; /* Color de borde marrón claro */
    border-radius: 4px;
    margin-bottom: 15px;
    background-color: #f0e3d2; /* Color de fondo para las secciones */
}
</style>
